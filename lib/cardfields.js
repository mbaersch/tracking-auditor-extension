...
export const CARD_FIELDS = {
  ...
  // The SDK's own events read as jargon on a card, so they get plain labels.
  openai:     { id: (r) => r.pixelId,      idTitle: 'Pixel ID (pid)',
    event: (r) => r.eventType === 'oai::diagnostic' ? 'SDK diagnostic'
      : r.eventType === 'openai::sdk_init' ? 'SDK initialised' : r.event, page: 'payload' },
};
