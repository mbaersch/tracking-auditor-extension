...
- Reads the event `name` (`PAGE_VIEW` automatic; conversions are advertiser-named —
  Purchase / AddToCart / Lead / ViewContent / …, kept verbatim), the page (`dl`) /
